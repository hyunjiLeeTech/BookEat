...
class CustomerReviewHistory extends Component {
    ...
    return this.state.reviews.map((review, index) => {
      ...
      return (
        <tr key={index} id={"reviewrow" + index}>
          <td>
            {moment(this.state.reviews[index].updatedAt).format("YYYY-MM-DD")}
          </td>
          <td defaultValue={this.state.reviews[index].restaurantId.resName}>
            {this.state.reviews[index].restaurantId.resName}
          </td>
          ...
          <td>
            <input
              ...
              name="picture1"
              id="picture1"
              defaultValue={this.state.picture1}
            ...
            {this.state.reviews[index].contenteditable ? (
              <img
                ...
                src={this.state.reviews[index].picture1}
                alt=""
              />
              ...
              <div>
                <img
                  ...
                  src={
                    serverAddress +
                    "/getImage/" +
                    this.state.reviews[index].pictures[0]
                  }
                  alt=""
                />
              </div>
          ...
          <td>
            <input
              ...
              name="picture2"
              id="picture2"
              defaultValue={this.state.picture2}
              // onChange={(e) => this.onImageChangepic2(e, index)}
              // disabled={(!this.state.reviews[index].contenteditable)}
              disabled
              className="border-0"
            ...
            {this.state.reviews[index].contenteditable ? (
              <img
                id={"picture2" + index}
                style={{maxHeight: "100%", maxWidth: "100%"}}
                src={this.state.reviews[index].picture2}
                alt=""
              />
              ...
              <div>
                <img
                  ...
                  src={
                    serverAddress +
                    "/getImage/" +
                    this.state.reviews[index].pictures[1]
                  }
                  alt=""
                />
              </div>
            ...
            <div className="form-inline">
              ...
              <div className="form-group">
                <button
                  ...
                  onClick={() =>
                    this.handleClickDeleteReview(
                      this.state.reviews[index]._id,
                      this.state.reviews[index].pictures,
                    )
                  }
                >
                  Delete
  ...
  handleClickEditReview(index) {
    this.state.reviews[index].contenteditable = !this.state.reviews[index]
      .contenteditable;
    // this.forceUpdate();
      ...
      () => {
        if (this.state.reviews[index].contenteditable) {
          $("#saveReviewChange")
            ...
            .attr("data-target", "#EditeReviewResultModal")
            .attr("type", "button");
        } else {
          $("#saveReviewChange")
            .attr("data-toggle", "")
      ...
      <Maincontainer>
        <form onSubmit={this.handleSubmit} id="reviewHistory">
          <div className="form-group">
            ...
            <table
              id="reivews"
              className="table table-striped col-md-12 table-responsive"
            >
              <thead>
                <tr>
                  <th>Date</th>
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <p
                    ...
                    id="DeleteReviewResultModalText"
                  >
                    Please Wait...
                  </p>
                </div>
