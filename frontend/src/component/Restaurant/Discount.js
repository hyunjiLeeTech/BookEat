...
class Discount extends Component {
  ...
  discountEditButton(index) {
    this.state.discounts[index].contentTable = !this.state.discounts[index]
      .contentTable;
  ...
  discountDeleteButton(index) {
    ds.deleteDiscount(this.state.discounts[index])
      .then(() => {
        this.queryDiscounts();
        this.setModal(
          true,
      ...
      () => {
        if (this.state.discounts[index].contentTable) {
          $("#save_edit_disc_btn")
            ...
            .attr("data-target", "#DiscountEditResultModal")
            .attr("type", "button");
        } else {
          $("#save_edit_disc_btn")
            .attr("data-toggle", "")
        ...
        <tr key={index}>
          <th>
            <input
              ...
              disabled={
                !this.state.discounts[index].contentTable ||
                !this.state.discounts[index].isActive
              }
          ...
          <th>
            <button
              id="save_edit_disc_btn"
              onClick={() => {
                this.discountEditButton(index);
              }}
              type="button"
          ...
          <th>
            <button
              ...
              onClick={() => {
                this.discountDeleteButton(index);
              }}
              data-toggle="modal"
        ...
        <div className="container">
          ...
          <div>
            ...
            <table id="discount" className="table table-striped">
              ...
              <tbody>{this.renderDataDiscount()}</tbody>
            </table>
          </div>
        </div>
