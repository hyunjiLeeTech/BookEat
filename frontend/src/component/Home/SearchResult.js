...
class SearchResult extends Component {
  ...
  componentWillMount() {
    ...
    //     }
    // }
    if (this.state.keyword != null) this.state.keyword = keyword;
    ...
    if (Object.prototype.toString.call(dt) === "[object Date]") {
      ...
      if (isNaN(dt.getTime())) {
        ...
        this.state.errmsg =
          "Date and time are required, please go back and search again.";
        this.forceUpdate();
      } else {
    ...
    if (!isNaN(Number.parseInt(numberOfPeople))) {
      ...
      this.state.resultsErr = true;
      this.state.errmsg =
        "Number of people is required, please go back and search again.";
      this.forceUpdate();
    }
          ...
          <div className="row">
              ...
              <div className="card-block">
                <Link
                  to={
                    ...
                    r._id +
                    "/" +
                    moment(new Date(this.state.dateTime)).format(
                      "YYYY-MM-DD/HH:mm",
                    ) +
                    "/" +
                ...
                >
                  <h6 className="card-title">
                    {r.resName ? r.resName : "unknown"}
                  </h6>{" "}
                </Link>
                <p className="card-text">
                  {this.getPriceRnageById(r.priceRangeId)}{" "}
                  {this.getCuisineNameById(r.cuisineStyleId)}{" "}
                  {this.getCategoryNameById(r.categoryId)}
                </p>
            ...
            <div className="col-md-6">
              <img
                ...
                src={serverAddress + "/getimage/" + r.pictures[0].toString()}
                alt="Restaurant"
              />
            </div>
          </div>
  ...
  render() {
    return (
      <MainContainer>
        ...
        {(!this.state.categoriesReady ||
          !this.state.priceRangesReady ||
          !this.state.cuisinesReady ||
          ...
          <div className="row">
            <div className="col-sm-4">
              <div>
                ...
                <hr />
                {this.state.priceRangesReady
                  ? this.renderPriceRange(this.priceRanges)
                  : null}
              </div>
              ...
              <div>
                ...
                <hr />
                {this.state.cuisinesReady
                  ? this.renderCuisineFirst5(this.cuisines)
                  : null}
                ...
                <div className="collapse list-unstyled" id="pageSubmenu">
                  {this.state.cuisinesReady
                    ? this.renderCuisineAfter5(this.cuisines)
                    : null}
                </div>
              </div>
              ...
              <div>
                ...
                <hr />
                {this.state.categoriesReady
                  ? this.renderCategory(this.categories)
                  : null}
              </div>
              <hr />
              <button
                className="btn btn-primary"
                onClick={this.querySearchResults}
              >
                Apply filters
              </button>
            </div>
