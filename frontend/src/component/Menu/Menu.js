...
const regExpPrice = RegExp(/(\d+\.\d{2,2})/g);
...
class Menu extends Component {
  ...
  onImageChange = (event, index) => {
    if (event.target.files && event.target.files[0]) {
      ...
      if (index !== undefined) {
        //in menu item  TRY YOUR BEST REWRITE THIS CODE
  ...
  handleChangeInList(e, index) {
    ...
    switch (name) {
      case "menuName":
        ...
        break;
      case "menuPrice":
        isError.menuPrice = regExpPrice.test(value)
          ? "&#160;"
  ...
  menuItemEditButton(index) {
    this.state.menus[index].contenteditable = !this.state.menus[index]
      .contenteditable;
  ...
  callModal(index) {
    this.setState((state) => () => {
      if (this.state.menus[index].contenteditable) {
        $("this.state.menus[index].#save_edit_btn")
          .attr("data-toggle", "modal")
          .attr("data-target", "#EditResultModal")
          .attr("type", "button");
      } else {
        $("this.state.menus[index].#save_edit_btn")
          .attr("data-toggle", "")
              ...
              <div className="container">
                <div className="row">
                  ...
                  {this.state.menus[index].contenteditable ? (
                    <img
                      id={"MenuPicture" + index}
                      style={{maxHeight: "100%", maxWidth: "100%"}}
                      src={this.state.menus[index].MenuPicture}
                      alt="Menu"
                    />
                  ) : (
                    <div>
                      <img
                        ...
                        style={{maxHeight: "100%", maxWidth: "100%"}}
                        src={
                          this.state.menus[index].menuImageId
                            ? serverAddress +
                              "/getImage/" +
                              this.state.menus[index].menuImageId
                            : ImageNotFound
          ...
          <td>
            <div className="container-fluid">
              ...
              <div className="form-inline">
                <textarea
                  row="3"
                  id={"menuDescript" + index}
                  name="menuDescript"
                  defaultValue={menuDescript}
                  onChange={(e) => this.handleChangeInList(e, index)}
              ...
              <div className="col-sm-9 border">
                <div className="col container-fluid">
                  <div className="form-inline mb-2">
                    <label htmlFor="menuName" className="col-sm-2 border-0">
                      Name{" "}
                    </label>
                    <input
                      type="text"
                  ...
                  <div className=" form-inline mb-2">
                    <label htmlFor="menuPrice" className="col-sm-2 border-0">
                      Price
                    </label>
                    <input
                      type="text"
                      ...
                      placeholder="price format: 12.30"
                      value={this.state.menuPrice}
                      className={
                        isError.menuPrice.length > 6
                          ? "is-invalid form-control"
                          : "form-control"
                      }
                      onChange={this.handleChange}
                  ...
                  <div className=" form-inline mb-2">
                    <label htmlFor="menuType" className="col-sm-2 border-0">
                      Menu Type
                    </label>
                    <select
                      className="form-conrol"
                  ...
                  <div className="form-inline">
                    <label htmlFor="allergy" className="col-sm-2 border-0">
                      Allergy
                    </label>
                    <select
                      className="form-conrol"
                  ...
                  <div className="form-inline">
                    <label htmlFor="menuDescript" className="col-sm-2 border-0">
                      Description
                    </label>
                    <textarea
                      row="3"
